...
import VehicleTripReportTab from "./tab";
...
function VehicleTripReport(props: Props) {
                        ...
                        <Col sm={12} md={6} className="pageEnd">
                          ...
                          props.vehicleTrips.result.length ? (
                            <CSVLink
                              ...
                              filename={"VehicleTrips-file.csv"}
                              data={props.vehicleTrips.result}
                              headers={vehicleTripReportDownloadColumns}
                            >
...
export default connect(mapStateToProps, mapDispatchToProps)(VehicleTripReport);
