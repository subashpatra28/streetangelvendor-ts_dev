...
import HighEventsTab from "./tab";

type Props = ReturnType<typeof mapStateToProps> &
  ReturnType<typeof mapDispatchToProps>;

function HighEvents(props: Props) {
                    ...
                    <div className="mb-4">
                      <Row className="mb-4">
                        ...
                        <Col sm={12} md={6} className="pageEnd">
                          {props.highEvents &&
                          props.highEvents.result &&
                          props.highEvents.result.length ? (
                            <CSVLink
                              className="pagebtn pagebtnexcept"
                              filename={"HignEvent-file.csv"}
                              data={props.highEvents.result}
                              headers={highEventsDownloadColumns}
                            >
                      ...
                      <div className="autocompletehead">
                        <Row>
                          ...
                          <Col xs={12} md={4}>
                            <DatePicker
                              className="datewidth eventsBottom eventsdate borderWidt"
                              // @ts-expect-error
                              menuIsOpen
                            />
                          </Col>
