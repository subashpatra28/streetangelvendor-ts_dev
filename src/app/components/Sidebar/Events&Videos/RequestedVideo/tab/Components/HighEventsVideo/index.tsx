...
import Loc from "./Components/loc/index.jsx";
import VideoGraph from "./Components/videoGraph/index.jsx";
import { Link } from "react-router-dom";
// @ts-expect-error TS(2307): Cannot find module '../../../../Common/FullPageLoa... Remove this comment to see the full error message
          ...
          <Row>
            ...
            <Col className="col-sm-12 tabAll" md={3}>
              <div className="boxNotes colDiv3">
                ...
                // ref={messageEl}
                >
                  {props.chatData.map((item: $TSFixMe) => (
                    <li
                      style={{
