...
import { DeleteDeviceCode } from "../../../../../../../redux/reducers/Management&Settings/deviceManagement/deviceManagement.actions";
import {
  endLoading,
  startLoading,
...
const Delete = (props: Props) => {
  async function deletePost() {
    if (window.confirm("Are you sure to delete this record?")) {
      try {
        props.startLoading();
        await toast.promise(props.deleteDevice(props.data.id) as any, {
...
const mapDispatchToProps = (dispatch: AppDispatch) => ({
  ...
  deleteDevice: (id: number) => dispatch(DeleteDeviceCode(id)),
});
